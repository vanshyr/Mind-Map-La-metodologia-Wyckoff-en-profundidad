...
### El ciclo del precio<!-- markmap: fold -->
...
- ![Ejemplo esquema rapido](https://raw.githubusercontent.com/vanshyr/Mind-Map-La-metodologia-Wyckoff-en-profundidad/main/img/esquema_rapido.png "Ejemplo esquema rapido")
...
- el movimiento del precio estará en proporción directa a la cantidad de esfuerzo dedicado. Tabla:<!-- marmap: fold -->
...
- ![](https://raw.githubusercontent.com/vanshyr/Mind-Map-La-metodologia-Wyckoff-en-profundidad/main/img/Ley_esfuerzo_resultado-por_ondas.png "Armonia y divergencia en el desarrollo de los movimientos por Ondas")
...
### Confirmación<!-- markmap: fold -->

## Parte 5: Las Fases

### Fase A - Parada tendencia previa<!-- markmap: fold -->

### Fase B - Construccion de la causa<!-- markmap: fold -->

### Fase C - Test<!-- markmap: fold -->

### Fase D - Tendencia dentro del rango<!-- markmap: fold -->

### Fase E - Tendencia fuera del rango<!-- markmap: fold -->

## Parte 6: Las Estructuras

### Horizontales<!-- markmap: fold -->

### Con pendiente<!-- markmap: fold -->

### Inusuales<!-- markmap: fold -->
...
### Zonas y niveles operativos<!-- markmap: fold -->
